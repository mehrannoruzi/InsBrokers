...
namespace InsBrokers.DataAccess.Ef.Migrations
{
    ...
    [Migration("20210518152635_Add.Action.StaticPath")]
    partial class AddActionStaticPath
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsBrokers.Domain.Action", b =>
                {
            ...
            modelBuilder.Entity("InsBrokers.Domain.ActionInRole", b =>
                {
            ...
            modelBuilder.Entity("InsBrokers.Domain.Role", b =>
                {
                    b.Property<int>("RoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("InsBrokers.Domain.UserInRole", b =>
                {
            ...
            modelBuilder.Entity("InsBrokers.Domain.VerificationCode", b =>
                {
            ...
            modelBuilder.Entity("InsBrokers.Domain.Action", b =>
                {
                    b.HasOne("InsBrokers.Domain.Action", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("InsBrokers.Domain.ActionInRole", b =>
                {
                    b.HasOne("InsBrokers.Domain.Action", "Action")
                        .WithMany("ActionInRoles")
                        .HasForeignKey("ActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InsBrokers.Domain.Role", "Role")
                        .WithMany("ActionInRoles")
