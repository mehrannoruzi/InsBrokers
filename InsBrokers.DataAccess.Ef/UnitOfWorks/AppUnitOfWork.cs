...
namespace InsBrokers.DataAccess.Ef
{
    public sealed class AppUnitOfWork : IElkUnitOfWork
    {
        ...
        public IGenericRepo<UserAttachment> UserAttachmentRepo => _serviceProvider.GetService<IGenericRepo<UserAttachment>>();
        ...
        public IGenericRepo<RelativeAttachment> RelativeAttachmentRepo => _serviceProvider.GetService<IGenericRepo<RelativeAttachment>>();
