var notifyType={success:"success",danger:"danger",info:"info",warning:"warning"},fireGlobalPlugins=function(){$(".pdate").Zebra_DatePicker()},customSerialize,postObjectList;$.fn.showMessage=function(n,t){let r=$(this),u=`<div class="row inner-notification">
                        <div class="col-12">
                            <div class="alert">
                                <p class="text"></p>
                            </div>
